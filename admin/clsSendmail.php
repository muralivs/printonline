...
class ComposeMail {
	...
	//Errors-To: <Broadcast@LAMarket.net>
//Reply-To: 
	...
	*/
	...
	This function sets the ReturnPath header
	*/
	function SH_ReturnTo($rt) {
		$this->headers["Return-To:"]="<".$rt.">";
	}
	
	function SH_ErrorsTo($rt) {
		$this->headers["Errors-To:"]="<".$et.">";
	}
	function SH_ReplyTo($rt) {
		$this->headers["Reply-To:"]="<".$rt.">";
	}
	
	
	function SH_ReturnReceptTo($rt) {
	...
	*/
	function BuildAndSendMessage() {
		...
		if ($this->headers["Return-To:"]=="") $this->headers["Return-To:"]="<".$this->from_addr.">";
		...
		echo mail($this->to,$this->subject,$theMessage,chop($theHeaders));
	}
	...
	function BuildAndSendMessageHTML() {
	
		$theMessage=$this->bodyParts["text/html"];
