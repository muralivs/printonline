...
-- 
-- Host: localhost
-- Generation Time: Jun 30, 2011 at 07:49 AM
-- Server version: 5.0.27
-- PHP Version: 5.2.1
-- 
-- Database: `2daybiz_businesscard`
-- 
...
CREATE TABLE `pfo_generalpackage` (
  `id` int(11) NOT NULL auto_increment,
...
CREATE TABLE `pfo_generalsettings` (
  `id` int(2) NOT NULL auto_increment,
...
(1, 'Business Card', 'Business Card', 'http://192.168.2.130/2daybiz/businesscard/project/businesscard/', 'info@2daybiz.com', 'logo.jpg', 'alagirivimal@i-netsolution.com', 'logo.jpg');
...
CREATE TABLE `pfo_membership_request` (
  `id` int(11) NOT NULL auto_increment,
...
CREATE TABLE `pfo_products` (
  ...
  `front_image` varchar(75) NOT NULL default '',
  `back_image` varchar(75) NOT NULL default '',
...
(1, 1, 1, 1, 'Test', 'H', '12936417321292489156Sunsetb.jpg', '12936417321292489156Sunsetbb.jpg', '', '', 1),
...
(3, 1, 2, 1, 'Test Product', 'H', '1294661046pro_card8.jpg', '1294661046pro_card8b.jpg', '', '', 1),
(4, 1, 0, 1, 'CropFraming products', 'H', '1294815395card-4.jpg', '1294815395card-4b.jpg', '', '', 1),
(5, 1, 1, 20, 'Test12', 'V', '1305177740Water lilies.jpg', '1305177740Water liliesb.jpg', '', '', 1),
(6, 1, 1, 1, 'test', 'H', '1307440463job-fair_04.jpg', '1307440463job-fair_04b.jpg', '', '', 1),
(7, 1, 1, 10, 'mukesh', 'H', '1309270202Water lilies.jpg', '1309270202Water liliesb.jpg', '', '', 1);
...
(116, 'aslı', 'asd', 'asddas', '', '3245234234', '', '', '69', 'asda', 'asdasd', '23424', 'dedevanya@gmail.com', '123456', '', '1296726549', '', 1, 1),
...
(145, 'Arun', 'kumar', 'shenoy nagar', '', '98765432111', '', '', '93', 'Tamilnadu', 'chennai', '60054', 'arun.inetsolution@gmail.com', '111111', '1305200411Water lilies.jpg', '1305108416', '1305200372', 1, 1),
...
(7, 145, 'itemImages/thumbs/1305181655Sunset.jpg', 'itemImages/thumbs/1305181655Water lilies.jpg');