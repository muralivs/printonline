...
if($installationtype == "upgrade297"){
   ...
   mysql_query($sql,$conn);   
   $sql = "ALTER TABLE `livehelp_departments` ADD `topbackground` VARCHAR( 255 ) NOT NULL default 'header_images/customersupport.png'";
   mysql_query($sql,$conn);   
   ...
   mysql_query($sql,$conn);   
   $sql = "UPDATE livehelp_departments set topframeheight='45',topbackground='header_images/customersupport.png',colorscheme='white'";
   mysql_query($sql,$conn);   
...
if( ($installationtype == "upgrade2125" ) || ($installationtype == "upgrade2126" ) || ($installationtype == "upgrade2127") ){           	 
 ...
 if( ($installationtype == "upgrade2129" ) || ($installationtype == "upgrade2130" ) || ($installationtype == "upgrade2131" ) || ($installationtype == "upgrade2140" ) ){
  ...
  if( ($installationtype == "upgrade2144") || ($installationtype == "upgrade2145") || ($installationtype == "upgrade2146") || ($installationtype == "upgrade2150")  ){
   ...
   $sql = "ALTER TABLE `livehelp_config` ADD `topframeheight` INT( 8 ) NOT NULL default '45' ,ADD `topbackground` VARCHAR( 156 ) NOT NULL  default 'header_images/customersupport.png'";
   mysql_query($sql,$conn);
 ...
 if( ($installationtype == "upgrade2161") || ($installationtype == "upgrade2162") || ($installationtype == "upgrade2163") ){
   ...
   $installationtype = "upgrade2164";
 }
 
 if($installationtype == "upgrade2164"){

   $sql = "UPDATE `livehelp_users` SET istyping=3";
   mysql_query($sql,$conn);  
    	
   $sql = "UPDATE livehelp_config set admin_refresh='auto',everythingelse='YY',version='$version'";
   mysql_query($sql,$conn);
 }
...
$mydatabase->query("INSERT INTO livehelp_modules_dep VALUES (2, 1, 2, 2, 'N', 'Y')");
		...
		$sql = "INSERT INTO livehelp_autoinvite VALUES (1, 'Y', 0, '1', '', 0, '', 'layer','30')";
$mydatabase->query($sql);
  ...
  //  $mydatabase->query($sql);
    ...
    $mydatabase->query($sql);		 
    $sql = "UPDATE livehelp_departments set topframeheight='75',topbackground='header_images/customersupport.png',colorscheme='white'";
   $mydatabase->query($sql);  
...
// default stuff...  				
		...
		$sql = "INSERT INTO `livehelp_autoinvite` VALUES (1, 'Y', 0, '2', '', 0, '', 'layer','30')";
    mysql_query($sql,$conn);
