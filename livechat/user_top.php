...
--> 
<body marginheight=0 marginwidth=0 leftmargin=10 topmargin=10 onload=window.focus(); bgcolor="#f1f5fe" background="../images/logo.jpg" style="background-repeat:no-repeat;"> 
