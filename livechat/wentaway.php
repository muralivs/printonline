...
<table width="100%" cellpadding=0 cellspacing=0 border=0 class="headerChat">
<tr>
<td width=1% background=images/blank.gif style="border-bottom:1px solid #666666;"><img src=images/blank.gif width=10 height=<?php echo $topframeheight ?> border=0><br>
</td>
<td width=99% background=images/blank.gif align=right style="border-bottom:1px solid #666666;">&nbsp;</td>
</tr>
</table>
<center><br>
<?php     
  print "<br><br><br><br><center><font color=#ff0000 size=+2>" . $lang['gone'] . "</font><br \><br \>";
  ...
  if($emailfun!="N"){
   ...
   <table width=400><tr><td align="justify">
     ...
     <br \><br \>
     <strong>Email:</strong>
	 <input name=sendto type=text size=40 class="txtBoxOne">  <input type=submit value="<?php echo $lang['SEND']; ?>" class="btnOne" >
   </td></tr></table>
  
   </FORM>
   <?php
   print "<br><br><a href=javascript:window.close() class='linkOne'>Close Window</a></center>"; 
  }
