...
<?php
 if($creditline == "N"){
  ?>  document.write('<a name="chatRef" href="<?php echo $urlreplace; ?>" <?php echo $target; ?> onclick="javascript:csTimeout=0;"><img name="csIcon" src="' + urltohelpimage + '" alt="Live Help" border="0"></a>');<?php
 } else {
   if(!(empty($UNTRUSTED['eo']))){
 ?>						 
   document.write('<a name="chatRef" href="<?php echo $urlreplace; ?>" <?php echo $target; ?> onclick="javascript:csTimeout=0;"><img name="csIcon" src="' + urltohelpimage + '" alt="Live Help" border="0"></a>');
 <?php } else { ?>  
