<?php
ob_start();
/*$server = 'mysql25.opentransfer.com';
$database = 'vsjayan_bcard';
$datausername = 'vsjayan_Ubcard';
$password = 'Bcard123';*/
...
/*$server='localhost';
$database='sjayan_businesscardnew';
$datausername = 'sjayan_bcardnew'; 
$password ='bcardnew!@#';*/


/*$server='localhost';
$database='customde_businessnew';
$datausername = 'customde_busines'; 
